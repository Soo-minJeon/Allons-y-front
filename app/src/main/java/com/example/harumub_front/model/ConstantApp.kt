...
object ConstantApp { // const => class(X) object(O)
    // static final
    ...
    @JvmField
    var VIDEO_DIMENSIONS = arrayOf( // VideoEncoderConfiguration.VideoDimensions[]
    ...
    @JvmField
    var VIDEO_FPS = arrayOf( // VideoEncoderConfiguration.FRAME_RATE[]
    ...
    const val ACTION_KEY_CHANNEL_NAME = "SeowonChannel"  // "ecHANEL"; // SeowonChannel
