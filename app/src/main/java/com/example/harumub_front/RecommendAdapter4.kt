...
class RecommendAdapter4(var titles: ArrayList<String>, var posters: ArrayList<String>):
    RecyclerView.Adapter<RecommendAdapter4.ViewHolder>() {
    ...
    // 순서에 따라 배열에 데이터 삽입
    override fun onBindViewHolder(holder: RecommendAdapter4.ViewHolder, position: Int) {
